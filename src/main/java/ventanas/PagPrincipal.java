...
public class PagPrincipal extends javax.swing.JFrame {
    ...
    public PagPrincipal() {
        ...
        //Imagen de saldo
        ImageIcon imagSaldo= new ImageIcon("src/main/java/images/ahorro.png");
        ...
        //Imagen de Depositar
        ImageIcon ImagDepositar= new ImageIcon("src/main/java/images/donar.png");
        ...
        //Imagen de Retirar
        ImageIcon imagRetirar= new ImageIcon("src/main/java/images/dinero_soporte.png");
        ...
        //Imagen de Abonar
        ImageIcon imagAbonar= new ImageIcon("src/main/java/images/alas_dinero.png");
    ...
    Image retValue = Toolkit.getDefaultToolkit().getImage("images/logo_protech.png");
    return retValue;
    }
    
    
    public void mostrarSaldo(String usuario) {
    // Muestra el saldo y la moneda
}
    ...
    private void initComponents() {
        ...
        jButton_FinPrograma.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        jButton_FinPrograma.setForeground(new java.awt.Color(255, 255, 255));
        jButton_FinPrograma.setText("Finalizar");
        ...
        getContentPane().add(jButton_FinPrograma, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 510, 150, 40));

        jButton_Abonar.setBackground(new java.awt.Color(0, 0, 0));
        jButton_Abonar.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        jButton_Abonar.setForeground(new java.awt.Color(255, 255, 255));
        jButton_Abonar.setText("Abonar");
